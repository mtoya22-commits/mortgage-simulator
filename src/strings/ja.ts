...
export const strings = {
  ...
  result: {
    ...
    monthlySection: {
      ...
      equalPrincipalNote:
        '元金均等は、返済初期の月返済額が大きく、後半に向けて下がっていきます。現在の毎月返済額の目安には「初回付近」を使い、参考として生涯の「平均」も表示しています。',
      note: '参考月返済額は、残高・金利・残り年数から計算した概算です。実際の返済額は、当初借入条件、返済方式、ボーナス返済、金利見直しルール、金融機関の端数処理などにより異なります。',
    },

    // 総支払額の目安（現在の残高から完済まで）
    totals: {
      heading: '総支払額の目安（現在条件）',
      totalPayment: '総返済額の概算',
      totalInterest: 'うち総支払利息の概算',
      caption:
        '現在の残高から完済までの概算です。金利・返済方式・ボーナス返済をもとにした目安で、実際の返済額は契約内容により異なります。',
      // 金利を動かして見るカード内
      rateAdjustLabel: '総支払利息（この金利の概算）',
      rateAdjustDiff: '現在条件との差',
      // 固定期間終了後カード内
      fixedLabel: '終了後想定金利での総支払利息（概算）',
    },
    ...
    // 1 年ごとの返済額の内訳（元金・利息）
    paymentChart: {
      heading: '1年ごとの返済額の内訳（元金・利息）',
      lead: '毎月返済額が、元金部分と利息部分にどう分かれていくかの目安です。',
      axisAge: '年齢',
      axisPayment: '毎月返済額',
      legendPrincipal: '元金',
      legendInterest: '利息',
      note: '毎月返済額のうち、元金と利息のおおよその内訳です。ボーナス返済は含みません。元利均等は返済額がほぼ一定で利息の割合が徐々に減り、元金均等は返済額が少しずつ下がります。実際の内訳は、契約内容・金融機関の計算方法により異なります。',
      empty: '残高・残り年数を入力すると、ここに返済額の内訳が表示されます。',
    },
